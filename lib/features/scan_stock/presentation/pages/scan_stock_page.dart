...
import '../widgets/scan_drobdown_chill.dart';
...
List<String> campus = ["MC Campus", "CC Campus", "NA"];
List<String> quality = ["High", "Mideal", "Low", "NA"];
                                                                    ...
                                                                    (index) {
                                                                      return MoonMenuItem(
                                                                        onTap:
                                                                            () {
                                                                          bloc.add(
                                                                              ClickSelectCampus(campus[index]));
                                                                        },
                                                                        width: double
                                                                            .infinity,
                                                                        label: Text(
                                                                    ...
                                                                    (index) {
                                                                      return MoonMenuItem(
                                                                        onTap:
                                                                            () {
                                                                          bloc.add(
                                                                              ClickSelectQuality(quality[index]));
                                                                        },
                                                                        width: double
                                                                            .infinity,
                                                                        label: Text(
